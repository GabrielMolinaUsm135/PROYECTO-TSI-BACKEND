...
class Instrumento extends Model {
    ...
    @Column({ type: DataType.STRING(255), allowNull: true, field: "nombre_instrumento" })
    declare nombre_instrumento: string | null;

    @Column({ type: DataType.STRING(255), allowNull: true, field: "modelo_instrumento" })
    declare modelo_instrumento: string | null;

    // field name contains a special character in the SQL (tamaño). Map to 'tamano' property
    @Column({ type: DataType.STRING(255), allowNull: true, field: "tamaño" })
